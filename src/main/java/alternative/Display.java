...
//        m_frame.setLocation(10,70);
        Dimension dimension = Toolkit.getDefaultToolkit().getScreenSize();
        int x = (int) ((dimension.getWidth() - m_frame.getWidth()) / 2);
        int y = (int) ((dimension.getHeight() - m_frame.getHeight()) / 2);
        m_frame.setLocation(x, y + 44);
//        m_frame.setLocationRelativeTo(null);
//        m_frame.setLocation(495, 140);

//        m_frame.setLocation(  (LwjglApp2.width) / 2 + 35, (LwjglApp2.height) / 2 + 70);
