...
public class Gradients {
    ...
    private final float[] m_texCoordX;
    private final float[] m_texCoordY;
    private final float[] m_oneOverZ;
    private final float[] m_depth;
    private final float[] m_lightAmt;

    private final float m_texCoordXXStep;
    private final float m_texCoordXYStep;
    private final float m_texCoordYXStep;
    private final float m_texCoordYYStep;
    private final float m_oneOverZXStep;
    private final float m_oneOverZYStep;
    private final float m_depthXStep;
    private final float m_depthYStep;
    private final float m_lightAmtXStep;
    private final float m_lightAmtYStep;
