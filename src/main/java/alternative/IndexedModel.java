...
public class IndexedModel {
    ...
    private final List<Vector4f> m_positions;
    private final List<Vector4f> m_texCoords;
    private final List<Vector4f> m_normals;
    private final List<Vector4f> m_tangents;
