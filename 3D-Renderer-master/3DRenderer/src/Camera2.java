...
public class Camera2
{
    ...
    public Camera2(Matrix4f projection)
    {
    ...
    public Matrix4f GetViewProjection()
    {
        ...
        Vector4f cameraPos = GetTransform().GetTransformedPos().Mul(-1).Add(new Vector4f(3f,-7f,6f,1f));
//        System.out.println(cameraPos.GetX() + "x" + cameraPos.GetY() + " Y " + cameraPos.GetZ() + "Z");
